...
public class MidPointCalculator {
    ...
    public static PlaceRequest calculateCenterPoint(List<PlaceRequest> places) {
    ...
    private static Coordinate calculateMidpoint(Coordinate[] geoPoints) {
        double x = 0, y = 0, z = 0;
    ...
    private static Coordinate toCartesian(double latDeg, double lonDeg) {
    ...
    private static Coordinate toGeoCoordinate(Coordinate coord) {
